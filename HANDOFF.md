...
> 当前版本：P03 + D05 + D06（seed260915），主表TIR97.08±4.50、TBR70 1.55±3.89、TBR54 .57±1.79。当前入口为[2026-09-17正文报告](RL_DSENet_2026-09-17/revision/论文正文对比报告.html)；模型不启用附加暂停或低糖奖励修改。版本指纹及复现入口见根目录README.md。



> 2026-09-17 正文对比修订完成：新增TD3+BC/IQL/LOM（ICLR2025）/GFP（ICLR2026）单seed训练，旧基线权重复用；8个外部方法+hold+ours、共同范围主表和原生附表均完成，1080条不同轨迹精确重算。ours TIR97.08% vs FQL89.78%，配对+7.30pp [2.62,12.44]，Holm p=.0273；但TBR70 1.55% vs .66%，TBR54 .57% vs .25%。本方法额外仿真信息L+S、单seed及个体低糖问题明确保留，不能称严格同训练数据或全指标SOTA。最新入口为 [正文报告](RL_DSENet_2026-09-17/revision/论文正文对比报告.html)、[交接证据](RL_DSENet_2026-09-17/revision/交接与证据.md)；旧内部版本表仅作开发/消融记录。Core/Harness不变。

> 2026-09-17 最新研究交付：DSENet已保持主结构适配Loop，四个patch参数初筛选P03（global12/3、local2/1），单seed260915完成预测/world/策略训练；32位Loop留出患者预测与12方法×60条冻结新场景控制已完成。最终仅策略TIR97.08%、TBR70 1.55%、TBR54 0.57%、0/60终止；相对hold有TIR—低糖交换，未显著胜过最强旧有界RL，adult009存在6次持续至少2小时低于54的事件，不能称可靠控制器。完整结果见 [报告](RL_DSENet_2026-09-17/训练审核报告.html) 与 [恢复交接](RL_DSENet_2026-09-17/阶段总结与恢复交接_2026-09-17.md)。本轮未重训旧baseline，Core/Harness及产品准入父项不变。
